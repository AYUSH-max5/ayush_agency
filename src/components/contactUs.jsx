...
export default function ContactSection() {
  return (
    <div className="w-full">
      ...
      <div className="block sm:hidden px-4 pt-8">
        <div className="bg-white shadow-lg rounded p-6 w-full max-w-md mx-auto">
          ...
          <form className="space-y-4">
            ...
            <div className="relative">
              <select className="appearance-none w-full border border-[#f1ded4] px-4 py-3 text-sm rounded text-[#3b1e1e] outline-none">
      ...
      {/* --- MAP WITH OVERLAY FORM FOR DESKTOP --- */}
      <div className="relative w-full h-[500px] mt-6 sm:mt-0">
        {/* Google Map */}
        <iframe
        ...
        {/* Desktop Form (Overlapping) */}
        <div className="hidden sm:block absolute left-10 top-10 md:left-20 md:top-20 bg-white shadow-lg rounded p-8 w-[350px] z-10">
          <h3 className="text-xl font-semibold text-[#3b1e1e] mb-6">Get In Touch</h3>
          <form className="space-y-4">
            <input
              type="email"
      ...
      <footer className="bg-[#fef0e9] px-10 py-12">
        ...
        {/* Bottom Bar */}
        <div className="mt-10 flex flex-col sm:flex-row justify-between text-xs text-[#6f5e5e] border-t border-[#ecd9d0] pt-6 gap-4">
